...
export function buildRootMetadata(lang) {
  ...
  return {
    ...
    title: {
      default: isFrench
        ? "Junior Mbogning | Cloud Platform / DevSecOps Engineer"
        : "Junior Mbogning | Cloud Platform / DevSecOps Engineer",
      template: "%s | Junior Mbogning"
    },
    description: isFrench
      ? "Site officiel de Junior Mbogning, doctorant en informatique et Senior Cloud Platform / DevSecOps Engineer, avec ses projets, articles et domaines d'expertise autour du Cloud, de Kubernetes et de la cybersécurité."
      : "Official website of Junior Mbogning, PhD candidate in Computer Science and Senior Cloud Platform / DevSecOps Engineer, featuring projects, articles and expertise in Cloud, Kubernetes and cybersecurity.",
...
export function buildPersonJsonLd(lang) {
  ...
  return {
    ...
    jobTitle:
      lang === "fr"
        ? "Doctorant en informatique et Senior Cloud Platform / DevSecOps Engineer"
        : "PhD candidate in Computer Science and Senior Cloud Platform / DevSecOps Engineer",
