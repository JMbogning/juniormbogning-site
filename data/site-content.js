export const siteContent = {
  ...
  fr: {
    ...
    aboutTitle: "À propos",
    about: [
      "Junior Mbogning est actuellement <strong>doctorant en informatique.</strong> Il est également <strong>Senior DevOps / DevSecOps Engineer</strong>, spécialisé dans la conception, l'automatisation et la sécurisation des infrastructures Cloud natives à grande échelle.",
      "Expert des technologies Cloud, DevOps et DevSecOps, il accompagne les organisations dans la modernisation de leurs systèmes d'information à travers l'automatisation des infrastructures, l'industrialisation des déploiements applicatifs et l'intégration de la sécurité au cœur du cycle de développement logiciel. Ses domaines d'expertise couvrent notamment <strong>Kubernetes, les plateformes Cloud, l'Infrastructure as Code, les chaînes CI/CD sécurisées et la résilience des infrastructures critiques.</strong>",
  ...
  en: {
    ...
    aboutTitle: "About",
    about: [
      "Junior Mbogning is currently a <strong>PhD candidate in Computer Science.</strong> He is also a <strong>Senior DevOps / DevSecOps Engineer</strong>, focused on designing, automating and securing large-scale cloud-native infrastructures.",
      "An expert in Cloud, DevOps and DevSecOps technologies, he helps organizations modernize their information systems through infrastructure automation, industrialized application delivery and the integration of security throughout the software development lifecycle. His areas of expertise notably include <strong>Kubernetes, Cloud platforms, Infrastructure as Code, secure CI/CD pipelines and the resilience of critical infrastructures.</strong>",
