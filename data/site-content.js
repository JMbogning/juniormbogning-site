export const siteContent = {
  ...
  fr: {
    ...
    about: [
      ...
      "Expert des technologies Cloud, Cloud Platform et DevSecOps, il accompagne les organisations dans la modernisation de leurs systèmes d'information à travers l'automatisation des infrastructures, l'industrialisation des déploiements applicatifs et l'intégration de la sécurité au cœur du cycle de développement logiciel. Ses domaines d'expertise couvrent notamment <strong>Kubernetes, les plateformes Cloud, l'Infrastructure as Code, les chaînes CI/CD sécurisées et la résilience des infrastructures critiques.</strong>",
      ...
      "Ainsi, il intervient régulièrement lors des ateliers techniques et programmes de formation consacrés au Cloud, à Kubernetes, au Cloud Platform et au DevSecOps. Il partage également son expertise à travers des contenus techniques et des retours d'expérience destinés à accompagner les professionnels dans l'adoption des meilleures pratiques d'ingénierie et de sécurité.",
  ...
  en: {
    ...
    about: [
      ...
      "He regularly contributes to technical workshops and training programs focused on Cloud, Kubernetes, Cloud Platform and DevSecOps. He also shares his expertise through technical content and field feedback designed to help professionals adopt strong engineering and security practices.",
